...
bool EvalState::isReserved(string var)
{
    if(var=="RUN"||var=="LET"||var=="LIST"||var=="QUIT"
       ||var=="HELP"||var=="REM"||var=="LET"||var=="PRINT"
       ||var=="INPUT"||var=="END"||var=="IF"||var=="THEN"
       ||var=="GOTO") return true;
    else return false;
}
